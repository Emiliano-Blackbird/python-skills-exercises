...
def bienvenida():
    while True:
        ...
        if nombre:  # Validamos que no esté vacío
            print(Fore.GREEN + f"\n¡Bienvenido a Python avanzado, {nombre.title()}!" + Style.RESET_ALL)
            break
        else:
    ...
    print(Fore.MAGENTA + f" ¡Listo, entorno cargado correctamente {nombre.title()}! A programar se ha dicho. ")
